...
class brand_products_page extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    print(productController.allProducts.length);
    final List<dynamic> cartprd = productController.allProducts
        .where((f) => f.brand == product.brand)
        .toList();
    print(cartprd.length);
...
class _addToCartState extends State<_addToCart> {
  ...
  Widget build(BuildContext context) {
    return ElevatedButton(
      ...
      child: isadded ? const Icon(Icons.done) : const Icon(Icons.shopping_cart),
    );
  }
}
